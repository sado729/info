...
<div class="modal fade form-make-standard" id="deleteProductModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content form-container">
            <div class="modal-content form-container">
                <div class="modal-header">
                    <h5 class="modal-title">Elanı silin</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="main-container" action="{{ route('product.deleteshow',['slug'=>$product->slug]) }}" method="post">
                        {{ csrf_field() }}
