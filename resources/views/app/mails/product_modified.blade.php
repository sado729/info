...
<p>Salam {{ $user['name'] }}, <b><a href="https://telefoncu.az/mehsul/{{ $product->slug }}" target="_blank">{{ ucfirst($product->name) }}</a></b> adlı elanınız müvəffəqiyyətlə dəyişdirilmişdir.
