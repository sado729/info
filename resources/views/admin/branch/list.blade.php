            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Bank Filialları</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <a class="btn btn-app" href="{{ route('branch.admin.create') }}" id="doadd">
                        ...
                        <div class="form-inline col-md-12 row mtb-10">
                            <form action="{{ route('branch.admin.index') }}" method="get" id="filterform">
                                <div class="col-md-4">
                                    <label>
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-responsive table-bordered table-striped table-hover" role="grid">
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="even">
                                                <td><input type="checkbox" name="check[]" value="{{ $branch->id }}"></td>
                                                <td>{{ $branch->id }}</td>
                                                <td>{{ $branch->name }}</td>
                                                @if(!$bank)<td>{{ $branch->bank->name }}</td>@endif
                                                <td>{{ $branch->phone }}</td>
                                                ...
                                                <td class="status">
                                                    <a href="{{ route('branch.admin.edit',$branch->id) }}">
                                                        <span class="glyphicon glyphicon-edit"></span>
                                                    </a>
                                                    <a href="{{ route('branch.admin.show',$branch->id) }}">
