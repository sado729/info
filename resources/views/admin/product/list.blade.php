            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Bank Məhsulları</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <a class="btn btn-app" href="{{ route('product.admin.create') }}" id="doadd">
                        ...
                        <div class="form-inline col-md-12 row mtb-10">
                            <form action="{{ route('product.admin.index') }}" method="get" id="filterform">
                                <div class="col-md-4">
                                    <label>
                        ...
                        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="nestable" class="table table-responsive table-bordered table-striped table-hover  sortable-theme-bootstrap" role="grid" data-url="{{ route('product.admin.sort') }}" data-sortable>
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="even tr" data-id="{{ $product->id }}">
                                                ...
                                                <td>{{ $product->name }}</td>
                                                <td>{{ $product->type }}</td>
                                                @if(!$bank)<td>{{ $product->bank->name }}</td>@endif
                                                <td>@if(!empty($product->image))
                                                    <img src="/uploads/product/{{ $product->id }}/large/{{ $product['image'] }}" alt="{{ $product->name }}" class="h50">
                                                    @else
                                                        Şəkil yoxdur
                                                    @endif
                                                </td>
                                                ...
                                                <td class="status">
                                                    ...
                                                    @if($product->temp)
                                                    <a href="{{ route('product.admin.showdiff',$product->id) }}">
