        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <a class="btn btn-app" href="{{ route('banner.admin.create') }}" id="doadd">
                        ...
                        <div class="form-inline col-md-12 row mtb-10">
                            <form action="{{ route('banner.admin.index') }}" method="get" id="filterform">
                                <div class="col-md-4">
                                    <label>
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-responsive table-bordered table-striped table-hover" role="grid">
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="even">
                                                <td><input type="checkbox" name="check[]" value="{{ $banner->id }}"></td>
                                                <td>{{ $banner->id }}</td>
                                                <td>{{ $banner->name }}</td>
                                                <td>{{ $banner->url }}</td>
                                                <td><img src="/uploads/banner/{{ $banner->id }}/large/{{ $banner->image }}" alt="{{ $banner->name }}" class="h50"></td>
                                                ...
                                                <td class="status">
                                                    ...
                                                    <a href="{{ route('banner.admin.show',$banner->id) }}">
                    ...
                    doactive.click(function() {
                        $.ajax({
                            ...
                            success: function(data) {
                                window.location.href = data.banner;
                            }
                        });
                    });
