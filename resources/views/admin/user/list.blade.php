        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <a class="btn btn-app" href="{{ route('user.admin.create') }}" id="doadd">
                        ...
                        <div class="form-inline col-md-12 row mtb-10">
                            <form action="{{ route('user.admin.index') }}" method="get" id="filterform">
                                <div class="col-md-4">
                                    <label>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td class="status">
                                                    ...
                                                    <a href="{{ route('user.admin.show',$user->id) }}">
    ...
    <script>
        $(document).ready(function () {
            let ckbox = $("input[name='check[]']"),
                ...
                dodelete = $("#dodelete"),
                checkall = $('#checkall'),
                tabletd = $('.even td input');

            checkall.click(function() {
                if ($(this).is(':checked')) {
                    tabletd.attr('checked', true);
                } else {
                    tabletd.attr('checked', false);
                }
            });
