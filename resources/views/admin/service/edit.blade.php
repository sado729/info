            ...
            <div class="row pt-2 pb-2">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('service.admin.index') }}">Services</a></li>
                    </ol>
                </div>
            </div>
            <!-- End Breadcrumb-->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form role="form" action="{{ route('service.admin.update',['id' => $service->id]) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <!-- Tab panes -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4 mt-20">
                                            ...
                                            <div class="input-group date">
                                                <input type="datetime-local" class="form-control pull-right" id="datepicker"  placeholder="Paylaşılma vaxtı" name="created_at" value="{{ \Carbon\Carbon::parse($service->getOriginal('created_at'))->format('Y-m-d\TH:i:s') }}">
                                            </div>
                                        </div>

                                        <div class="form-footer col-md-12 mt-20 text-center">
                                            <a href="{{ route('service.admin.index') }}" id="cancel" type="submit" class="btn btn-danger">
                            ...
                            @if(!empty($service->image))
                                <div class="row">
                                    @foreach($service->image as $gal)
                                        <div class="col-md-2 gallery" id="{{ $gal->id }}">
                                            <a class="gal-item showcase" data-rel="lightcase:myCollection:slideshow" title="{{ $gal->name }}" href="{{ '/uploads/service/'.$service->id.'/gallery/large/'.$gal->image }}">
                                                <figure><img class="gal-item-img" src="{{ '/uploads/service/'.$service->id.'/gallery/little/'.$gal->image }}"></figure>
                                            </a>
                                            <br>
