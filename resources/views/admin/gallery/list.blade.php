            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Qalereya</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <a class="btn btn-app" href="{{ route('gallery.admin.create') }}" id="doadd">
                        ...
                        <div class="form-inline col-md-12 row mtb-10">
                            <form action="{{ route('gallery.admin.index') }}" method="get" id="filterform">
                                <div class="col-md-4">
                                    <label>
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-responsive table-bordered table-striped table-hover" role="grid">
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="even">
                                                <td><input type="checkbox" name="check[]" value="{{ $gallery->id }}"></td>
                                                <td>{{ $gallery->id }}</td>
                                                <td>{{ $gallery->name }}</td>
                                                <td>{{ $gallery->slug }}</td>
                                                <td>
                                                ...
                                                <td class="status">
                                                    <a href="{{ route('gallery.admin.edit',$gallery->id) }}">
                                                        <span class="glyphicon glyphicon-edit"></span>
                                                    </a>
                                                    <a href="{{ route('gallery.admin.show',$gallery->id) }}">
                    ...
                    doactive.click(function() {
                        $.ajax({
                            ...
                            success: function(data) {
                                window.location.href = data.gallery;
                            }
                        });
                    });
