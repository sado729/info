...
return [
    ...
    */
    ...
    'supportedLocales' => [
        'az'          => ['name' => 'Azerbaijani (Latin)',    'script' => 'Latn', 'native' => 'Azərbaycan dili', 'regional' => 'az_AZ', 'code' => 'AZ'],
        'en'          => ['name' => 'English',                'script' => 'Latn', 'native' => 'English', 'regional' => 'en_GB', 'code' => 'EN'],
        'ru'          => ['name' => 'Russian',                'script' => 'Cyrl', 'native' => 'Русский', 'regional' => 'ru_RU', 'code' => 'RU'],
    ],
